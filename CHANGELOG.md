...
- Added base implementation of saving user uploaded files to the browsers IndexDB storage. Added a new StoredFilesList component that can be opened via the top left of the side panel [`c1446d1`](https://github.com/fingerthief/minimal-chat/commit/c1446d1616a1b298ac705cc0d4cbd83688302f44)
- Improved the stored files dialog/component. [`492b921`](https://github.com/fingerthief/minimal-chat/commit/492b921901c1ef7f6a43578ddc0f4351e146124a)
- Updated to use the built in events for speech detection instead of rolling out own manual polling for speech. [`2f2164e`](https://github.com/fingerthief/minimal-chat/commit/2f2164eb546731b1b05d33d172e2bdd5b61a3208)

...
const ARRAY_PROPS_WITH_NESTED_OBJECT = {
  modules: {
    Slider: {
      type: 'Component',
      components: {
...
const EVENT_NESTED_OBJECT_PROPS = {
  modules: {
    Switch: {
      type: 'Component',
      components: {
...
const TWO_COMPONENTS_SAME_FILE = {
  modules: {
    MyComponents: {
      type: 'Component',
      components: {
...
const EXCLUDE_IOS_TWO_COMPONENTS_DIFFERENT_FILES = {
  modules: {
    ComponentFile1: {
      type: 'Component',
      components: {
